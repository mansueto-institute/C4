// g++ -I ~/anaconda/include/ vor.cxx -std=c++11 -pg --coverage -Wall -o vor && ./vor
...
int main()
{
    ...
    const int points_per_circle = 50;
    boost::geometry::strategy::buffer::distance_symmetric<double> distance_strategy(sqrt(max_dist));
    ...
    // boost::geometry::buffer(vd_ctr, vd_buff, bgeo::strategy::buffer::distance_symmetric<double>(max_dist));
    ...
    mapper.map(poly,    "fill-opacity:0.3;fill:rgb(0,0,255);stroke:rgb(0,0,255);stroke-width:0,2");
    mapper.map(vd_buff, "fill-opacity:0.4;fill:rgb(255,0,0);stroke:rgb(255,0,0);stroke-width:0,2", 5);
